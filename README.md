...
- Wallet login still requires Sui ownership confirmation through signed messages, while memory persistence uses Walrus blob IDs.
...
- `contracts/sources/recall_memory.move` - Optional Sui Move experiment, not required for the current Walrus blob-ID demo.
